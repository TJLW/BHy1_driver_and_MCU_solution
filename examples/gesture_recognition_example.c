...
/*																	*/
/*	This demo showcases the gesture recognition in the context of	*/
/*	a mobile device. Every time the Android Gestures "Pickup", 		*/
/*	"Glance" or "Significant motion" are detected, it sends them	*/
/*	along with the system timestamp to the Serial port				*/
